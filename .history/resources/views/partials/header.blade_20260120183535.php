...
<nav class="bg-primary-dark text-white flex justify-between items-center px-6 py-3 shadow-lg z-20">
    <div class="flex items-center gap-3">
        <svg class="w-7 h-7 text-blue-300" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
    ...
    <div class="flex items-center gap-5">
        ...
        <div class="relative">
            <button id="user-menu-button"
                ...
                <img class="w-8 h-8 rounded-full" src="https://placehold.co/40x40/60A5FA/FFF?text=D"
                    alt="User avatar" />
            ...
            <div id="user-menu"
                ...
                <a href="{{ url('/logout') }}" class="block px-4 py-2 text-sm text-danger-dark hover:bg-danger-light"

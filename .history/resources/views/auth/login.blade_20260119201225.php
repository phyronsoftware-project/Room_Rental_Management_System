...
<body class="min-h-screen bg-slate-50 flex items-center justify-center px-4 py-10">
    <div class="w-full max-w-md">
        ...
        <div class="bg-white border border-slate-200 rounded-2xl shadow-lg p-6 sm:p-8">
            ...
            <form id="loginForm" action="{{ route('authenticate') }}" onsubmit="return false;" class="space-y-5">
                ...
                <div>
                    ...
                    <div class="relative">
                        <input id="email" type="email" required placeholder="admin@example.com" value=""

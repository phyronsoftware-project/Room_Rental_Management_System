  ...
  <div class="w-full max-w-md">
    ...
    <div class="mb-6 text-center">
      <div class="mx-auto w-12 h-12 rounded-2xl bg-blue-100 flex items-center justify-center">
        <!-- Home icon -->
        <svg xmlns="http://www.w3.org/2000/svg" class="w-7 h-7 text-blue-700" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor">
          <path stroke-linecap="round" stroke-linejoin="round" d="M3 10.5 12 3l9 7.5V21a.75.75 0 0 1-.75.75H3.75A.75.75 0 0 1 3 21V10.5z" />
    ...
    <div class="bg-white border border-slate-200 rounded-2xl shadow-lg p-6 sm:p-8">
      ...
      <form id="loginForm" action="javascript:void(0)" onsubmit="return false;" class="space-y-5">
          ...
          <div class="relative">
            ...
            <span class="absolute inset-y-0 right-0 flex items-center pr-3 text-slate-400 pointer-events-none">
              ...
              <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke-width="1.6" stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" d="M21.75 6.75v10.5A2.25 2.25 0 0 1 19.5 19.5h-15A2.25 2.25 0 0 1 2.25 17.25V6.75m19.5 0A2.25 2.25 0 0 0 19.5 4.5h-15A2.25 2.25 0 0 0 2.25 6.75m19.5 0-9.75 6.5-9.75-6.5" />
              </svg>
            </span>
          </div>
        </div>
        ...
        <div>
          ...
          <div class="relative">
            ...
            <button type="button" onclick="togglePassword()"
              ...
              <svg id="eyeOpen" xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke-width="1.6" stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" d="M2.036 12.322a1.012 1.012 0 0 1 0-.639C3.423 7.51 7.36 4.5 12 4.5c4.638 0 8.573 3.007 9.963 7.178.07.207.07.431 0 .639C20.577 16.49 16.64 19.5 12 19.5c-4.638 0-8.573-3.007-9.963-7.178z" />
                <path stroke-linecap="round" stroke-linejoin="round" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
              </svg>
              <svg id="eyeClosed" xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 hidden" fill="none" viewBox="0 0 24 24" stroke-width="1.6" stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" d="M3 3l18 18" />
                <path stroke-linecap="round" stroke-linejoin="round" d="M10.5 10.677A2.999 2.999 0 0 0 12 15a2.999 2.999 0 0 0 2.323-1.5" />
                <path stroke-linecap="round" stroke-linejoin="round" d="M6.228 6.228C4.44 7.61 3.11 9.52 2.25 12c1.39 4.171 5.325 7.5 9.75 7.5 1.58 0 3.086-.424 4.398-1.164" />
                <path stroke-linecap="round" stroke-linejoin="round" d="M9.88 4.67A10.49 10.49 0 0 1 12 4.5c4.638 0 8.573 3.007 9.963 7.178.158.46.158.684 0 1.144a12.74 12.74 0 0 1-1.347 2.746" />
              </svg>

              <span id="toggleText" class="text-xs font-semibold">Show</span>
            </button>
          </div>

          <div class="mt-2 flex items-center justify-between">
            <label class="inline-flex items-center gap-2 text-sm text-slate-600 cursor-pointer">
              <input type="checkbox" class="rounded border-slate-300 text-blue-600 focus:ring-blue-500/40" checked />
              Remember me
            </label>
        ...
        <button id="loginBtn" type="button" onclick="fakeLogin()"
          ...
          <svg id="spinner" class="w-5 h-5 hidden animate-spin" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
  ...
  <script>
    ...
    function fakeLogin() {
      ...
      setTimeout(() => {
        ...
        alertBox.className = 'mb-5 px-4 py-3 rounded-lg text-sm border bg-emerald-50 border-emerald-200 text-emerald-800';

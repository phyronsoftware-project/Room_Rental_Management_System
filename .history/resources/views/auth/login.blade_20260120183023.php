        ...
        <div class="bg-white border border-slate-200 rounded-2xl shadow-lg p-6 sm:p-8">
            ...
            <form id="loginForm" method="POST" action="{{ route('authenticate') }}" class="space-y-5">
                ...
                <div>
                    ...
                    <div class="relative">
                        <input id="email" type="email" name="gmail" required placeholder="admin@example.com" value=""
                ...
                <div>
                    ...
                    <div class="relative">
                        <input id="password" type="password" name="passw" required minlength="6" placeholder="••••••••"
                            value=""

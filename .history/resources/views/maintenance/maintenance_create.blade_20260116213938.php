...
<main class="flex-1 overflow-y-auto bg-base">
  <div class="p-10 max-w-4xl mx-auto">
    ...
    <div class="flex items-center gap-4 mb-6">
      <a href="#" class="text-text-mid hover:text-primary transition-colors" aria-label="Back">
      ...
      <div>
        ...
        <p class="text-sm text-text-mid mt-1">Signed in as <span class="font-semibold">{{ $admin_name }}</span></p>
      </div>
    </div>

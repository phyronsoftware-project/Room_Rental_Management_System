    ...
    <main class="flex-1 overflow-y-auto bg-base">
        <div class="p-10 space-y-6">
            ...
            <div class="flex justify-between items-center">
                <h1 class="text-3xl font-bold text-primary-dark">MAINTENANCE</h1>
                <a href="{{ route('maintenance.createblade') }}"
            ...
            <div class="bg-light p-6 rounded-lg shadow-md border border-gray-200">
                <div class="grid grid-cols-1 md:grid-cols-3 gap-x-6 gap-y-4 items-end">
                    <div class="space-y-1">
                        <label class="text-xs font-semibold text-text-mid">STATUS</label>
                        <select
                    ...
                    <div class="space-y-1">
                        <label class="text-xs font-semibold text-text-mid">DATE REPORTED</label>
                        <div class="relative">
                            <input type="date"
                    ...
                    <div class="space-y-1">
                        <label class="text-xs font-semibold text-text-mid">SEARCH</label>
                        <div class="relative">
                            <input type="text"
                                class="form-input w-full border border-gray-300 rounded-lg p-2.5 text-sm text-text-dark focus:outline-none focus:ring-2 focus:ring-primary/50"
            ...
            <div class="bg-light rounded-lg shadow-md border border-gray-200">
                    ...
                    <table class="w-full text-sm text-left text-text-mid">
                        <thead class="text-xs text-text-dark uppercase bg-gray-50 font-semibold">
                            <tr>
                                ...
                                <th scope="col" class="px-6 py-3">Issue Reported</th>
                        ...
                        <tbody>
                            ...
                            <tr class="bg-light border-b hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4">Leaky Faucet</td>
                                <td class="px-6 py-4">
                                    <span
                                        class="px-2.5 py-1 text-xs font-medium rounded-full bg-success-light text-success-dark">Completed</span>
                                </td>
                                <td class="px-6 py-4">01 November 2025</td>
                                <td class="px-6 py-4">Mr. Handy</td>
                            ...
                            <tr class="bg-light border-b hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4">Broken Light Fixture</td>
                                <td class="px-6 py-4">
                                    <span
                                        class="px-2.5 py-1 text-xs font-medium rounded-full bg-warning-light text-warning-dark">Pending</span>
                                </td>
                                <td class="px-6 py-4">10 November 2025</td>
                            ...
                            <tr class="bg-light border-b hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4">A/C Not Cooling</td>
                                <td class="px-6 py-4">
                                    <span
                                        class="px-2.5 py-1 text-xs font-medium rounded-full bg-primary-light text-primary">In
                                        Progress</span>
                                </td>
                                <td class="px-6 py-4">08 November 2025</td>
                                <td class="px-6 py-4">A/C Services</td>
                                <td class="px-6 py-4 text-center">
                                    <div class="relative inline-block">
                                        <button class="text-text-mid p-1 rounded-full hover:bg-gray-200"
                                            data-action="toggle-dropdown">
                            ...
                            <!-- Table Row 4 -->
                            <tr class="bg-light border-b hover:bg-gray-50">
                                <td class="px-6 py-4 font-medium text-text-dark">F-5</td>
                                <td class="px-6 py-4">Water Heater Issue</td>
                                <td class="px-6 py-4">
                                    <span
                                        class="px-2.5 py-1 text-xs font-medium rounded-full bg-success-light text-success-dark">Completed</span>
                                </td>
                                <td class="px-6 py-4">28 October 2025</td>
                                <td class="px-6 py-4">Mr. Handy</td>
                                <td class="px-6 py-4 text-center">
                                    <div class="relative inline-block">
                                        <button class="text-text-mid p-1 rounded-full hover:bg-gray-200"
                            ...
                            <tr class="bg-light border-b hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4">Jammed Door Lock</td>
                                <td class="px-6 py-4">
                                    <span
                                        class="px-2.5 py-1 text-xs font-medium rounded-full bg-warning-light text-warning-dark">Pending</span>
                                </td>
                                <td class="px-6 py-4">11 November 2025</td>
                                <td class="px-6 py-4">-</td>
                                <td class="px-6 py-4 text-center">
                                    <div class="relative inline-block">
                                        <button class="text-text-mid p-1 rounded-full hover:bg-gray-200"
                ...
                <div class="p-5 flex justify-between items-center text-sm text-text-mid">
                    <div>
                        <span class="font-semibold text-text-dark">1 - 5</span> of
                        <span class="font-semibold text-text-dark">12</span>
                    </div>
